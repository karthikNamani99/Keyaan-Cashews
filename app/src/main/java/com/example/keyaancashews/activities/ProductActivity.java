...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(singleProduct != null){
            ...
            productSize.setText("Quantity: " + String.valueOf(singleProduct.getProductSize()+"Kg"));
            productColor.setText("Quality: " + singleProduct.getProductColor());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(buildCounterDrawable(mCount, R.drawable.carts));
        return true;
    }
